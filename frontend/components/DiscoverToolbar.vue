  ...
  <div class="flex flex-col gap-4 sm:flex-row sm:items-center">
    ...
    <div class="flex shrink-0 items-center gap-2">
      <div class="relative">
        <select
          :value="sort"
          class="appearance-none rounded-full border border-surface-border bg-surface-raised py-3 pl-4 pr-10 text-sm text-white focus:border-trust-500 focus:outline-none"
      ...
      <button
        ...
        :class="viewMode === 'map' ? 'border-trust-500 bg-trust-600/20 text-trust-400' : 'border-surface-border bg-surface-raised text-gray-400 hover:border-gray-500 hover:text-white'"
      ...
      <button
        type="button"
        class="flex h-11 w-11 items-center justify-center rounded-full border text-lg transition"
        :class="viewMode === 'list' ? 'border-trust-500 bg-trust-600/20 text-trust-400' : 'border-surface-border bg-surface-raised text-gray-400 hover:border-gray-500 hover:text-white'"
        title="List view"
